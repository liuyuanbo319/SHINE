...
class Inception1d(nn.Module):
    ...
    def __init__(self, num_classes=2, input_channels=8, kernel_size=41, depth=6, bottleneck_size=32, nb_filters=32,
    ...
    def forward(self, x):
        repre = self.layers[:-1](x)
        logits = self.layers[-1](repre)
        return logits,repre
