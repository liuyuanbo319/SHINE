...
# 1 AVR 2 I AVL 3 V5 V6 4 V3 V4 5 V1 V2 6 II III AVF
...
class MyNet6View(nn.Module):
    ...
    def __init__(self, features_num,ts_length,num_classes=5):
    ...
    def forward(self, x):
        if self.features_num==1:
            outputs_view = self.MyNet1(x)

            x_out = self.fc(outputs_view)
        else:
