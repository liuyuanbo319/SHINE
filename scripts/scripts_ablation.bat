...
set METHODS= SHINE
set DIR=F:\TS_DATA\dataset\EEG\%DATASET%
...
python ../run.py --run_name SHINE/Aug --model_name SHINE --dataset %DATASET% --num_runs %NUM_RUNS% --preprocessed_dir %DIR% --aug_type ww --z_dim %Z%
python ../run.py --run_name SHINE/Aug --model_name SHINE --dataset %DATASET% --num_runs %NUM_RUNS% --preprocessed_dir %DIR% --aug_type ss --z_dim %Z%
