...
set METHODS= SHINE
set DIR=F:\TS_DATA\dataset\ECG\ECG200
...
python ../run.py --run_name SHINE/Aug-ww --model_name SHINE --dataset %DATASET% --num_runs %NUM_RUNS% --preprocessed_dir %DIR% --aug_type ww --z_dim %Z%
python ../run.py --run_name SHINE/Aug-ss --model_name SHINE --dataset %DATASET% --num_runs %NUM_RUNS% --preprocessed_dir %DIR% --aug_type ss --z_dim %Z%
